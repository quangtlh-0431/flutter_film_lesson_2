...
class _$ExternalsImpl implements _Externals {
  const _$ExternalsImpl({this.tvrage, this.thetvdb, this.imdb});
...
class _$ImageImpl implements _Image {
  const _$ImageImpl({this.medium, this.original});
...
abstract class _Image implements Image {
  const factory _Image({final String? medium, final String? original}) =
      _$ImageImpl;
...
class _$LinksImpl implements _Links {
  const _$LinksImpl({this.self, this.previousepisode});
...
abstract class _Links implements Links {
  const factory _Links(
      {final Previousepisode? self,
      final Previousepisode? previousepisode}) = _$LinksImpl;
...
class _$PreviousepisodeImpl implements _Previousepisode {
  const _$PreviousepisodeImpl({this.href});
...
abstract class _Previousepisode implements Previousepisode {
  const factory _Previousepisode({final String? href}) = _$PreviousepisodeImpl;
...
class _$NetworkImpl implements _Network {
  const _$NetworkImpl({this.id, this.name, this.country, this.officialSite});
...
class _$CountryImpl implements _Country {
  const _$CountryImpl({this.name, this.code, this.timezone});
...
class _$RatingImpl implements _Rating {
  const _$RatingImpl({this.average});
...
abstract class _Rating implements Rating {
  const factory _Rating({final double? average}) = _$RatingImpl;
...
class _$ScheduleImpl implements _Schedule {
  const _$ScheduleImpl({this.time, final List<String>? days}) : _days = days;
...
abstract class _Schedule implements Schedule {
  const factory _Schedule({final String? time, final List<String>? days}) =
      _$ScheduleImpl;
